...
/**
 * Stereo-linked look-ahead peak limiter for the binaural output, tuned to stay out of the way: it only has work to
 * do on the rare peaks the binaural mix pushes past [ceilingDb] after [BinauralRenderer]'s headroom trim (measured
